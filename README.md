...
1. Na tela principal, veja as encomendas listadas com cliente, produto, valor e status de pagamento.
2. Um resumo no topo mostra o faturamento total, quantas encomendas faltam pagar e quantas já foram pagas e aguardam entrega.
3. Toque em uma encomenda para marcar como **paga** e/ou como **entregue** — os totais e contadores são atualizados na hora.
4. Encomendas marcadas como entregues passam para a aba **"Entregues"**.
...
| Cor principal | `#8B6AAE` |
| Ícone | Tesoura + agulha com linha, em traço branco, sobre fundo degradê roxo — remete ao trabalho manual do ateliê. |
...
4. Rode em um emulador ou dispositivo físico com o Android configurado para depuração USB.
...
- [`CANVAS.md`](CANVAS.md) — visão geral do projeto
- [`PRD.md`](PRD.md) — requisitos detalhados do produto
- [`AGENTS.md`](AGENTS.md) — regras de uso da IA neste projeto
- [`docs/USO_DE_IA.md`](docs/USO_DE_IA.md) — registro de uso da IA
